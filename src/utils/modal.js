 ...
 */
export const showModal = async (title, text, icon = 'info') => {
 ...
 */
export const showConfirmationModal = async (title, text, confirmButtonText = "Confirmar", cancelButtonText = "Cancelar") => {
    const result = await Swal.fire({
        title,
        text,
