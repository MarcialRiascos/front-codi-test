    ...
    return (
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="sm:max-w-[720px] h-[90vh] overflow-y-auto">
                    <DialogHeader className='mb-5'>
                        <DialogTitle>Registrar nuevo administrador</DialogTitle>
                        <DialogDescription className='flex flex-col space-y-3'>
                            <span>Intruduce los datos del nuevo administrador</span>
                            <span>Requerido *</span>
                        </DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmitRegister)} className='space-y-5'>
