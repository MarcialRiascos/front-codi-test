...
export const getDataBeneficiary = async (url) => {
    try {
        const response = await fetch(`${API_URL}/${url}`, {
            method: 'GET',
            headers: {
...
export const updateEndpoint = async (url, id, data) => {
    try {
...
export const fetchApiExternal = async (url) => {
    try {
...
export async function fetchApi(url, method, body, headers = { "Content-Type": "application/json" }, includeCredentials = false // Nuevo parámetro para incluir cookies
) {
